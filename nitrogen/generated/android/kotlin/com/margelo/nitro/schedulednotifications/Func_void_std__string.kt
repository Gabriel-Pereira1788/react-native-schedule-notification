...
/**
 * Represents the JavaScript callback `(notificationId: string) => void`.
...
fun interface Func_void_std__string: (String) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(notificationId: String): Unit
}
...
class Func_void_std__string_cxx: Func_void_std__string {
  ...
  @Keep
  override fun invoke(notificationId: String): Unit
    = invoke_cxx(notificationId)

  @FastNative
  private external fun invoke_cxx(notificationId: String): Unit
}
...
class Func_void_std__string_java(private val function: (String) -> Unit): Func_void_std__string {
  ...
  @Keep
  override fun invoke(notificationId: String): Unit {
    return this.function(notificationId)
  }
}

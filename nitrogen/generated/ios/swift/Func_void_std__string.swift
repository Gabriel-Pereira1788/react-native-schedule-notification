...
/**
 * Wraps a Swift `(_ notificationId: String) -> Void` as a class.
...
public final class Func_void_std__string {
  ...
  private let closure: (_ notificationId: String) -> Void

  public init(_ closure: @escaping (_ notificationId: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(notificationId: std.string) -> Void {
    self.closure(String(notificationId))
  }
